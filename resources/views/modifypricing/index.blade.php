...
@section('content')
	...
	<div class="employeePricingTitle">{{ __('PRICINGS') }}</div>
	<div class="employeePricing">
		<div class="employeePricingBackground"></div>
    	<form method="post" id="modifyPricing" action="{{ route('modify-pricing.update') }}">
        	...
        	<table>
        		<tr>
            		<th><div class="employeeWeekDay">{{ __('week day') }}</div></th>
            	...
            	@foreach($weekDays as $weekDay)
            		<tr>
                		<td><div class="employeeWeekDay">{{ __($weekDay) }}</div></td>
        	...
        	<div class="employeePricingButton">
    			<button class="btn btn-warning" type="submit" id="updatePricingButton" disabled>{{ __('ACCEPT') }}</button>
    		</div>
    	</form>
	</div>
@endsection